function [clsfError,stats] = task7NNFunction(filename,activationFunction)
    type = 2; % 2 for NN
    ...
    elseif type == 2 % classifier
        ...
        hiddenActivationFunctions = {activationFunction,activationFunction,'softmax'};
    ...
    plotname = strcat('Activation function: ',activationFunction);
    title(plotname);
