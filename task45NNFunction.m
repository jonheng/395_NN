function initialNNFunction(filename,schType,scalingFactor,lrEpochThres,dropoutType,weightPenaltyL1,weightPenaltyL2)
    type = 2; % 2 for NN
    ...
    nn.trParams.lrParams.schedulingType = schType;
    % set scaling Factor
    nn.trParams.lrParams.scalingFactor = scalingFactor;
    ...
    nn.weightConstraints.weightPenaltyL1 = weightPenaltyL1;
    % squared weight penalty
    nn.weightConstraints.weightPenaltyL2 = weightPenaltyL2;
    ...
    if weightPenaltyL1 ~= 0
        plotname = strcat('schType =  ', num2str(schType), ', scalingFactor =  ', num2str(scalingFactor), ', lrEpochThres =  ', num2str(lrEpochThres), ', weightPenaltyL1 =  ', num2str(weightPenaltyL1));
    elseif weightPenaltyL2 ~= 0
